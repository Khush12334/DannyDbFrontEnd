...
import { submitLogin, submitUpdate } from 'app/auth/store/loginSlice';
...
function JWTLoginTab(props) {
  ...
  useEffect(() => {
    setValue('displayName', user.data.displayName, { shouldDirty: true, shouldValidate: true });
    setValue('email', user.data.email, { shouldDirty: true, shouldValidate: true });
    setValue('password', user.data.password, { shouldDirty: true, shouldValidate: true });
  ...
  function onSubmit(model) {
    console.log(user)
    dispatch(submitUpdate(user, model));
  }
